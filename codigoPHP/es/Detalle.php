...
<html lang="es">
    ...
    <body>
        ...
        <footer>
            <p>2023-2024 © Todos los derechos reservados. <a href="https://github.com/kyrafenrir/202DWESLoginLogoffTema5/blob/master/codigoPHP/Detalle.php">Erika Martínez Pérez</a></p>
        </footer>
    </body>
</html>